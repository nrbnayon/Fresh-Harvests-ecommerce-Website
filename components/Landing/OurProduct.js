...
export default function OurProduct() {
  ...
  return (
    <div className='min-h-screen container mx-auto bg-white py-16'>
      <div className='relative max-w-full sm:max-w-[1200px] mx-auto sm:px-6'>
        ...
        {/* Background images */}
        <div className='absolute top-8 right-[78px] sm:block hidden'>
          <Image src={l1} alt='bg' width={67} height={61} />
        </div>
        <div className='absolute top-16 left-[78px] sm:block hidden'>
