  ...
  return (
    <div className='block'>
      <Link
        ...
        className='block'
      >
        <div className='bg-white md:max-w-[320px] rounded-3xl px-3 pt-3 pb-5 flex flex-col items-center shadow-lg transition-all duration-300 hover:border-gray-300 hover:shadow-2xl hover:-translate-y-1 hover:scale-105'>
